...
looker.plugins.visualizations.add({
    ...
    updateAsync: function (data, element, config, queryResponse, details, done) {
        ...
        data.map((row) => {
            ...
            const rowTopic = row["dim_zi_intent_metrics.topic"].value
            const rowMoreTopics = row["dim_zi_intent_metrics.company_topic_count"].value
            ...
            const companyIntent = numberWithCommas(Math.round(row["dim_zi_intent_metrics.monthly_intent_12_mos"].value))
