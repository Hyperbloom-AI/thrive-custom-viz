...
looker.plugins.visualizations.add({
    ...
    updateAsync: function (data, element, config, queryResponse, details, done) {
        ...
        // Parse the Data
            ...
            var x = d3.scaleBand()
                .range([0, width])
                .domain(data.map(function (d) { return d["dim_zi_company_entities.zi_c_company_employee_range"].value }))
                .padding(0.2);
            ...
            svg.selectAll("mybar")
                ...
                .enter()
                .append("rect")
                .attr("x", function (d) { return x(d["dim_zi_company_entities.zi_c_company_employee_range"].value); })
