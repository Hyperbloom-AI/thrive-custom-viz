...
looker.plugins.visualizations.add({
    id: "thrive_custom_companies_table",
    label: "Custom Companies Table",
    ...
    create: function (element, config) {
        ...
        <style>
            ...
            * {
            ...
            .company-location-count, .revenue-range, .employee-range, .business-type, .company-description, .company-website {
                font: 14px/16px Helvetica;
            }
    ...
    updateAsync: function (data, element, config, queryResponse, details, done) {
        ...
        data.map((row) => {
            ...
            companyWebsiteWrapper.innerHTML = `<a href="https://${rowWebsite}">${rowWebsite}</a>`
            ...
            companyLocationCountWrapper.className = "company-location-count"
            const rowLocationCount = row["dim_zi_company_entities.total_zi_c_num_locations"].value
            companyLocationCountWrapper.innerHTML = `<span>${rowLocationCount}</span>`
