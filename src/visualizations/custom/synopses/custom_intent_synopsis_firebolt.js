...
looker.plugins.visualizations.add({
    id: "thrive_custom_intent_synopsis",
    label: "Custom Intent Synopsis",
    ...
    updateAsync: function(data, element, config, queryResponse, details, done) {
      ...
      this._blockElement2ValueWrapper.innerHTML = `<h3>${numberWithCommas(Math.round(data[0]["dim_zi_intent_by_entity_topic.monthly_intent_12_mos_per_company"].value))}</h3>`
      ...
      this._blockElement2SubtitleWrapper.innerHTML = `<h5>Total Intent: ${numberWithCommas(Math.round(data[0]["dim_zi_intent_by_entity_topic.monthly_intent_12_mos"].value))}</h5>`
